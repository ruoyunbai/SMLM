...
# chkpt= torch.load('chkps/data/multi/v2/checkpoint_40.pt') 
# chkpt= torch.load('chkps/data/multi/v3/checkpoint_20.pt')
# chkpt= torch.load('chkps/data/multi/v4/checkpoint_50.pt')
chkpt= torch.load('chkps/data/multi/v5.1/checkpoint_50.pt')
